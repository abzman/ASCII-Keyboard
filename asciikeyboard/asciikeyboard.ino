...
const byte key_scancode[][8] = {
  ...
  {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff},                  //A3 "wildcard","(I)","(II)","(III)","(IV)","(V)","(VI)","undo"
  ...
  {0x5c, 0x1b, 0x00, 0x00, 0x20, 0xff, 0xff, 0xf9},                  //A10 "\","escape","","","space","move","store","clear"
  ...
  {0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},                  //A15 "home","","","","","","",""
};
